...
**Where this is documented:** the tagging rules and agent flow are described **on this page** (you are in the right place) and summarized under **[LLM tagging workflow](../appendix/technical_reference#llm-tagging-workflow)** in the Technical reference. The AFDD stack **[Data modeling hub](https://bbartling.github.io/open-fdd-afdd-stack/modeling/)** and **[OpenClaw + Docker BACnet + UI round-trip](../howto/openclaw_bacnet_docker_and_human_modeling)** cover the same workflows for humans and agents.
